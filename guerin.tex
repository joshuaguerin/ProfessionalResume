...
%	\cvSection{Current Position}
	...
	\CVBlockWithTime{DPLL}{}{}{}{
        ...
        \vspace{-20pt}
        \hspace{-20pt}
	\CVBlockWithTime{doqmnt}{}{}{}{
          \begin{itemize}            
            \setlength{\itemsep}{1pt}                                        
            \setlength{\parskip}{0pt}                                        
            \setlength{\parsep}{0pt}                                         
            \item An \href{https://github.com/joshuaguerin/doqmnt}{Emacs extension} for automatic/interactive generation of function, class, and file documentation.
          \end{itemize}
        }
	...
	\CVBlockWithTime{Kattis Solutions}{}{}{}{
          \begin{itemize}            
            ...
            \setlength{\parskip}{0pt}                                        
            \setlength{\parsep}{0pt}                                         
            \item A \href{https://github.com/joshuaguerin/Kattis-Solutions}{set of solutions} for problems on the competitive programming site \href{https://open.kattis.com/}{open.kattis.com/}.
          \end{itemize}
        }
